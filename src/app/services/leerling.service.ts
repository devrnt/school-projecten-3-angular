...
export class LeerlingService {
  ...
  constructor(private _http: HttpClient, private _richtingService: RichtingService, private _competentieService: CompetentieService) {
    ...
    leerling1.competenties = this._competentieService.hoofdcompetenties;
    leerling1.projecten = [];
    ...
    leerling2.competenties = this._competentieService.hoofdcompetenties;
    leerling2.projecten = [];
